...
import com.spikes2212.lib.command.drivetrains.TankDrivetrain;
...
public class Drivetrain extends TankDrivetrain { //TODO revert this to an OdometryDrivetrain
...
//    private PigeonWrapper imu;
    ...
    public static Drivetrain getInstance() {
        if(instance == null) {
            ...
            WPI_VictorSPX leftSPX = new WPI_VictorSPX(RobotMap.CAN.DRIVETRAIN_LEFT_VICTOR);
            WPI_VictorSPX rightSPX = new WPI_VictorSPX(RobotMap.CAN.DRIVETRAIN_RIGHT_VICTOR);

            leftSPX.follow(left);
            rightSPX.follow(right);
...
//            PigeonWrapper imu = new PigeonWrapper(left);
            instance = new Drivetrain(left, right, leftEncoder, rightEncoder);
        }
        return instance;
    }
...
//                0,0);
    ...
    public void arcadeDrive(double moveValue, double rotateValue) {
        super.arcadeDrive(0.4 * moveValue, 0.6 * rotateValue);
    }
