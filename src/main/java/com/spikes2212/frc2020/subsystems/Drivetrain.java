...
public class Drivetrain extends OdometryDrivetrain {
  ...
  public static Drivetrain getInstance() {
    if (instance == null) {
      ...
      Encoder leftEncoder = new Encoder(RobotMap.DIO.DRIVETRAIN_LEFT_ENCODER_POS,
          RobotMap.DIO.DRIVETRAIN_LEFT_ENCODER_NEG);
      Encoder rightEncoder = new Encoder(RobotMap.DIO.DRIVETRAIN_RIGHT_ENCODER_POS,
          RobotMap.DIO.DRIVETRAIN_RIGHT_ENCODER_NEG);
